...
const NEARBY_CITIES: Record<string, NearbyCity[]> = {
    seattle: [
        ...
        { name: "Everett", state: "WA", lat: 47.9790, lon: -122.2021, distance: "25 mi north" },
    ...
    "new york": [
        ...
        { name: "White Plains", state: "NY", lat: 41.0340, lon: -73.7629, distance: "25 mi north" },
    ...
    "los angeles": [
        ...
        { name: "Burbank", state: "CA", lat: 34.1808, lon: -118.3090, distance: "10 mi north" },
    ],
    chicago: [
        { name: "Evanston", state: "IL", lat: 42.0450, lon: -87.6877, distance: "14 mi north" },
        { name: "Oak Park", state: "IL", lat: 41.8850, lon: -87.7845, distance: "10 mi west" },
    ...
    phoenix: [
        ...
        { name: "Tempe", state: "AZ", lat: 33.4255, lon: -111.9400, distance: "10 mi southeast" },
    ...
    philadelphia: [
        ...
        { name: "King of Prussia", state: "PA", lat: 40.1013, lon: -75.3836, distance: "20 mi northwest" },
        { name: "Wilmington", state: "DE", lat: 39.7447, lon: -75.5484, distance: "30 mi southwest" },
    ],
    "san antonio": [
        { name: "New Braunfels", state: "TX", lat: 29.7030, lon: -98.1245, distance: "30 mi northeast" },
    ...
    dallas: [
        { name: "Irving", state: "TX", lat: 32.8140, lon: -96.9489, distance: "10 mi northwest" },
    ...
    jacksonville: [
        ...
        { name: "St. Augustine", state: "FL", lat: 29.9012, lon: -81.3124, distance: "40 mi southeast" },
    ...
    "san jose": [
        ...
        { name: "Palo Alto", state: "CA", lat: 37.4419, lon: -122.1430, distance: "20 mi northwest" },
    ],
    austin: [
        ...
        { name: "Georgetown", state: "TX", lat: 30.6333, lon: -97.6770, distance: "30 mi north" },
    ...
    "san francisco": [
        ...
        { name: "Berkeley", state: "CA", lat: 37.8715, lon: -122.2730, distance: "12 mi northeast" },
        { name: "Daly City", state: "CA", lat: 37.6879, lon: -122.4702, distance: "8 mi south" },
        { name: "San Mateo", state: "CA", lat: 37.5630, lon: -122.3255, distance: "20 mi south" },
    ],
    indianapolis: [
        { name: "Carmel", state: "IN", lat: 39.9784, lon: -86.1180, distance: "15 mi north" },
    ...
    "washington": [
        { name: "Arlington", state: "VA", lat: 38.8816, lon: -77.0910, distance: "5 mi southwest" },
    ...
    nashville: [
        ...
        { name: "Hendersonville", state: "TN", lat: 36.3048, lon: -86.6200, distance: "20 mi northeast" },
