...
import type { CurrentWeather, DailyPeriod, HourlyPeriod, WeatherIcon, WeatherError, } from "@shared/types";
...
export async function getCurrentWeather(
    ...
    if (forecastResult.ok) {
        const firstDay = forecastResult.data.properties.periods.find(
            (p) => p.isDaytime
        );
